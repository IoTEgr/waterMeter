...
s32_t userConfigReset(void)
{
	...
	/*configSet(CONFIG_ID_MJPEG_W,     448);//448
	configSet(CONFIG_ID_MJPEG_H,     120);//120

	configSet(CONFIG_ID_CENTER_X,    80);//80
	configSet(CONFIG_ID_CENTER_Y,    160);//160
	*/

	configSet(CONFIG_ID_MJPEG_W,     512);//448 512
	configSet(CONFIG_ID_MJPEG_H,     160);//120 160

	configSet(CONFIG_ID_CENTER_X,    80);//80
	configSet(CONFIG_ID_CENTER_Y,    160);//160


/*	configSet(CONFIG_ID_MJPEG_W,     640);
	configSet(CONFIG_ID_MJPEG_H,     480);

	configSet(CONFIG_ID_CENTER_X,    0);//50
	configSet(CONFIG_ID_CENTER_Y,    0);//110
*/	
	userConfigSave();
	return 0;
}
