...
//=====sensor VGA  check all frame=======
#define  HAL_CFG_MD_VGA_SX        0
#define  HAL_CFG_MD_VGA_EX        640
#define  HAL_CFG_MD_VGA_SY        0
#define  HAL_CFG_MD_VGA_EY        480

//=====sensor 720P  check frame center =======
#define  HAL_CFG_MD_720P_SX        320
#define  HAL_CFG_MD_720P_EX        (320+640)
#define  HAL_CFG_MD_720P_SY        180
#define  HAL_CFG_MD_720P_EY        (180+360)
...
* Return         : s32 : 0 success
                             <0 fail 
*******************************************************************************/
s32 hal_mdInit(u8 type)
{
	if(0==type)
	{
		ax32xx_mdXPos(HAL_CFG_MD_720P_SX,HAL_CFG_MD_720P_EX);
		ax32xx_mdYPos(HAL_CFG_MD_720P_SY,HAL_CFG_MD_720P_EY);
	}
	else
	{
		ax32xx_mdXPos(HAL_CFG_MD_VGA_SX,HAL_CFG_MD_VGA_EX);
		ax32xx_mdYPos(HAL_CFG_MD_VGA_SY,HAL_CFG_MD_VGA_EY);
	}
...
/*******************************************************************************
* Function Name  : hal_md_reset_checktime
* Description    : hal layer .motion dectetion check md event time over will start
* Input          :  None
* Output         : None
* Return         : None
*******************************************************************************/
void hal_md_reset_checktime()
{
	halmd_checktime = 100;	// 1s
}
