...
//---------------------------------------ax32xx configure table------------------------------
    ...
    #define  JPEG_QI          4
#elif(AX32_PLATFORM == AX3282S||AX32_PLATFORM == AX3293||AX32_PLATFORM == AX3293B||AX32_PLATFORM == AX3293C)
	#define  UART0_TX_POS     UART0_POS_PA7
    #define  UART0_RX_POS     UART0_POS_NONE
    #define  UART0_BAUDRATE   115200


	#define  UART1_TX_POS     UART1_POS_PF10
    #define  UART1_RX_POS     UART1_POS_PF11
